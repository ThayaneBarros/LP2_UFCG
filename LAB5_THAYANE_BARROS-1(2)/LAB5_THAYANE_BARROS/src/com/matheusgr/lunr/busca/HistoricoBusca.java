...
public class HistoricoBusca {
	...
	private BuscaInterface tipoDeBusca;

	/**
	 * Construção do histórico a partir dos parâmetros de busca (definido pelo
	 * objeto de busca) e resultado da consulta.
	 * 
	 * @param tipoDeBusca O tipo de busca que indicará o objeto de busca realizado.
	 * @param documentosIds Resultado da pesquisa.
	 */
	public HistoricoBusca(BuscaInterface tipoDeBusca, String[] documentosIds) {
	 ...
	 */
	public String[][] debug() {
		return this.tipoDeBusca.descreveConsulta();
	}
