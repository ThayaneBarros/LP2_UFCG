...
public class BuscaService {
	...
	/**
	 * Realiza uma operação de busca. Toda busca deve retornar um documento
	 * e grau de relevância (de maior para menor).
	 * 
	 * @param tipoDeBusca O tipo de busca a ser realizada.
	 * @return Resultado das buscas.
	 */
	public DocumentoDTO[] busca(BuscaInterface tipoDeBusca) {
		Map<Documento, Integer> respostaDocumento = tipoDeBusca.busca(this.ds);
		DocumentoDTO[] documentos = ordena(respostaDocumento);
		this.br.adicionaBusca(tipoDeBusca, documentos);
		return documentos;
	}
